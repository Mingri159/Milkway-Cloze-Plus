...
- 做了个简易的设置弹窗；
  ...
  ![image](https://forumcdn.freemdict.com/uploads/default/original/3X/e/2/e2e6cb5cdd411c3f5bb36d46971143035d8e7c41.png)
...
- **<font color=MediumOrchid>---------------2023.4.25---------------：</font>**

- 修复：等级标注后，多次点击【Tail+】按钮时，其失效及乱码问题；

- **<font color=MediumOrchid>---------------2023.6.9---------------：</font>**

- 添加：设置中添加【阅读区 右键取消标注功能】；

- 优化：设置项hover提示；

- **<font color=MediumOrchid>---------------2023.6.12---------------：</font>**

- 修复：修复右侧释义列表点击单词后滚动位置不正确的bug；

- 添加：左侧阅读区生词hover时显示序号，方便对应右侧释义列表；
...
### 五、本地使用【Milkway-Cloze-Plus-Vue】

- 安装**python**，[Welcome to Python.org](https://www.python.org/)
- 双击`start.bat`，自动打开浏览器页面；
